...
?>
	...
	<section class="paging-center">
		...
		{ ?>
            <a href="index.php?page=admin&paging=<?=$prevPage;?>" class="button" role="button">&#10094;</a>
        <?php } ?>
        
        	<a href="index.php?page=admin&paging=<?=$currentPage;?>" class="button" role="button">Page <?=$currentPage;?></a>

        <?php if ($nextPage <= $totalPage)
        { ?>
            <a href="index.php?page=admin&paging=<?=$nextPage;?>" class="button" role="button">&#10095;</a>
        <?php } ?>
